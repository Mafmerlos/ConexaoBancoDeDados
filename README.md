...
Como Usar
Ao executar o programa, será solicitado que você insira as seguintes informações no terminal:
Nome
Data de nascimento (formato DD/MM/YYYY)
Endereço
CPF
O sistema irá cadastrar as informações inseridas no banco de dados MySQL.
Licença
